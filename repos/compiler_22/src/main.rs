...
// const BOOLEAN_TAG_FLAG :i64 = 1;
// const INT_TAG_FLAG :i64 = 0;
...
fn compile_to_instrs(e: & Expr, si: i32, env: & HashMap<String, i32>, break_label: &String, l: &mut i32) -> Vec<Instr> {
    ...
    match e {
        Expr::Number(n) => {
          // instr_vector.extend(check_overflow1(Val::Reg(Reg::RAX)));
...
// fn check_overflow1(_v: Val) -> Vec<Instr> {
//   let mut instr_vect = Vec::new();
//   instr_vect.push(Instr::IJo("throw_overflow_error1".to_string()));
//   instr_vect
// }
        ...
        Sexp::Atom(I(n)) => {
          match i64::try_from(*n) {
            Ok(num) => {
              ...
              // println!("n_bits - {}, {}, {}", n_bits, I63_MAX, I63_MIN);
              // if n_bits > 62 {
